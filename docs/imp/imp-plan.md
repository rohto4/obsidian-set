...
- 個人ブログ系の情報は公式情報ではないため、採用判断の根拠ではなく「試す案」として扱う。詳細は `docs/spec/practical-obsidian-workflows.md` に分離した。
...
2. `docs/spec/` に技術・構成・採用判断を書く。
3. `docs/imp/` に作業計画、判断待ち、AI作業状況を書く。
4. notes は小さく始め、必要になったカテゴリだけ追加する。
5. MCP / Local REST API / Sync / VS Code extension は検証候補として保持し、いきなり導入しない。
...
- 出力先: `docs/spec/vscode-extensions.md`
...
- 出力先: `.markdownlint.json` または `docs/spec/markdownlint.md`
- 状態: done
- 理由: Markdown repo として品質を保つ。VS Code extension と CLI の両方に効く。
- 完了内容: `docs/spec/markdownlint.md` にルール案を作成。設定ファイルの追加は判断待ち。

### 10. Obsidian Sync / Git 併用方針を整理する

- 出力先: `docs/spec/sync-strategy.md`
- 状態: done
...
- 出力先: `docs/spec/obsidian-local-rest-api.md`
- 状態: done
...
- 出力先: `docs/spec/obsidian-mcp-evaluation.md`
- 状態: done
...
- 出力先: `docs/spec/practical-obsidian-workflows.md`
- 状態: done
...
- 出力先: `docs/spec/sql-queryable-vault.md`
- 状態: done
...
4. `docs/spec/sync-strategy.md`
5. `docs/spec/obsidian-mcp-evaluation.md`
...
- `docs/spec/vscode-extensions.md`
- `docs/spec/web-clipper.md`
- `docs/spec/knowledge-category-options.md`
- `docs/guide/ai-session-summary.md`
- `docs/spec/codex-obsidian-mcp-roadmap.md`
