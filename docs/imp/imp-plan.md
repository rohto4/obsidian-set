...
- 今できること: frontmatter schema と更新ルールを書く。
...
- 今できること: `research-ops` の evidence boundary を PJルールへ移す。
...
- 今できること: ルール案だけ先に作る。設定ファイルの追加は判断待ち。
...
- 理由: MCP 連携の現実的な土台。
- 今できること: 安全な検証手順を書く。Obsidian plugin install は判断待ち。
...
次は `docs/guide/dev-knowledge-taxonomy.md`、`docs/guide/ai-knowledge-taxonomy.md`、`docs/guide/source-backed-notes.md`、`docs/spec/vscode-extensions.md` が自然な続き。
