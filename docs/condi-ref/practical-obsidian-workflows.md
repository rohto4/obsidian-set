...
- ただしユーザ要望ではカテゴリ候補を比較したいので、現時点では `docs/condi-ref/knowledge-category-options.md` の判断待ち。
...
- 最初は `docs/condi-ref/knowledge-category-options.md` の候補だけに留める。
...
3. `docs/condi-ref/knowledge-category-options.md` に Zettelkasten minimal folders 案を統合する。
